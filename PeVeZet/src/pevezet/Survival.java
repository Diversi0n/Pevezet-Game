...
public class Survival extends PApplet {
    ...
    private String lagu = "src/assets/Adventure/LevelSelect.wav";
    ...
    private int playerSun, food,spawntime=20, zombieget,ambil;
    ...
    public void loadAsset() {
        ...
        for(int i = 0; i < 22; i++){
            swim[i] = loadImage("src/assets/Zombies/DuckyTube/swim/"+(int)Math.floor(i/100)+""+(int)Math.floor(i/10%10)+""+i%10+".png");
        }
        ...
        if(time % 20 == 0)
        {
            ...
            if(playgrass){
                ...
                if(time<=80){
                    ...
                    ambil = rand.nextInt(1, 5);
                    if(ambil==1){
                        zombieget = rand.nextInt(0, 2);
                    }
                    else if(ambil==2||ambil==3){
                        zombieget = 5;
                    }
                    else if(ambil==4){
                        zombieget = 4;
